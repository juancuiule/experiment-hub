  ...
  return (
    <div className={twMerge(component.props.alignBottom ? "mt-auto pt-5" : "")}>
      <button
        ...
        className="w-full h-10 bg-background-inverted text-content-inverted uppercase text-sm font-medium tracking-wide rounded-sm hover:bg-background-inverted/80 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer transition duration-150 ease-out"
      >
        {isLoading ? "…" : text}
      </button>
    </div>
